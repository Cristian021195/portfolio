    ...
    const _conocimientos = [
        {
            ...
            list:['Maquetación Básica.','Atributos de accesibilidad','Metaetiquetas para SEO y PWA','Insercion de Videos, Audios.','Formularios','Templates', 'Svg']
        },
        {
            titulo:'CSS3',
        ...
        },
        {
            ...
            list:['Organizacion de ficheros para proyecto', 'Documentacion adecuada de proyectos', 'Express', 'Socket.io']
        },
        {
            titulo:'MySql',
